...
class TestOrderViews:
    ...
    def paypal_mock(self):
        ...
        with (
            patch("backend.apps.orders.views.create_order") as mock_create,
            patch("backend.apps.orders.views.capture_order") as mock_capture,
        ):
    ...
    def test_checkout_paypal_api_failure(self, client, product):
        ...
        with patch("backend.apps.orders.views.create_order") as mock_create:
